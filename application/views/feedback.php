                    ...
                    <div class="dragArea row">
                        <div class="col-md-4  form-group" data-for="name">
                            <label for="name-form1-5m" class="form-control-label thw-fonts-style display-7">Họ và
                                Tên</label>
                            <input name="name" data-form-field="Name" required="required" class="form-control display-7" type="text" placeholder="Lê Văn Đạt" id="name-form1-5m">
                        </div>
                        <div class="col-md-4  form-group" data-for="email">
                            <label for="email-form1-5m" class="form-control-label thw-fonts-style display-7">Email</label>
                            <input type="email" name="email" data-form-field="Email" required="required" class="form-control display-7" placeholder="datvl123@gmail.com" id="email-form1-5m">
                        </div>
                        <div data-for="phone" class="col-md-4  form-group">
                            <label for="phone-form1-5m" class="form-control-label thw-fonts-style display-7">Số điện
                                thoại</label>
                            <input type="tel" name="phone" data-form-field="Phone" class="form-control display-7" placeholder="0909123456" id="phone-form1-5m">
                        </div>
